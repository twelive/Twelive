...
4. Redux와 supabase 를 활용하여 프로젝트 만들어 보기 
...
# 1. 메인 페이지
## 메뉴바 - 호버 라이트/다크모드 <br>
![ezgif com-resize_2](https://github.com/twelive/final-project/assets/117728530/2d4e0c52-9e3a-4538-b4de-8c45f7f2a1eb)

![ezgif com-resize_3](https://github.com/twelive/final-project/assets/117728530/a45ba68e-5742-469f-98af-b08451e989fa)
## 메인 페이지 - 다크모드 <br>
...
| 이름                   | 회고내용                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |     |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --- |
| 정소이         | 2주 동안 Redux를 경험해보면서 에러 원인을 정확히 예측할 수 없어 힘들었지만, reducer 생성을 통한 상태 관리 방법과 여러 에러 상황을 알고 사용법을 알았다는 점에 의의가 있었습니다. 또한 조원 모두 GitHub 관리를 마스터한 점이 뿌듯했습니다. 다음 프로젝트에서는 이를 바탕으로 상태 관리 방법을 개선하고 Styled-component를 목적에 알맞게 사용하고 싶습니다. 조원들 3주도 화이팅합시다 :9                                                                                                                                                                                                                                          |
