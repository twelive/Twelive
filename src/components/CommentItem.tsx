        ...
        <CommentAdd>
          <CommentFormArea>
            ...
            <CommentButton type="submit" form="comment">
              <CommentButtonText>답글</CommentButtonText>
            </CommentButton>
          </CommentFormArea>
          <CommentListWrapper>
            {comments.map((comment) => (
              <CommentList key={comment.id}>
                ...
                <CommentButtonContainer>
                  ...
                  <CommentEdit onClick={() => handleEdit(comment.id)}>
                    <CommentButtonText>수정</CommentButtonText>
                  </CommentEdit>
                  <CommentDelete onClick={() => handleDelete(comment.id)}>
                    <CommentButtonText>삭제</CommentButtonText>
                  </CommentDelete>
                </CommentButtonContainer>
              </CommentList>
            ))}
